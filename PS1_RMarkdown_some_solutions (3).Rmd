...
H\_0                                         & \multicolumn{1}{c|}{daily log returns} & weekly log returns \\ \hline
N(0,1)                                       & \multicolumn{1}{c|}{3406}              & 431                \\
t\_4                                         & \multicolumn{1}{c|}{147}               & 114                \\
Mix of N(), $\alpha=0.07$, $\sigma^2_2=3.86$ & \multicolumn{1}{c|}{729}               & 84                
\end{tabular}
\end{table}
...
compute_cross_autocorrelation <- function(data, lags) {
  ...
  for (lag in lags) {
    ...
    rownames(gamma) <- paste0(series_names, "_t-", lag)
...
round(gamma_matrices$gamma_0, 3)
round(gamma_matrices$gamma_1, 3)
round(gamma_matrices$gamma_2, 3)
round(gamma_matrices$gamma_3, 3)
round(gamma_matrices$gamma_4, 3)
...
```
```{r ACF and PACF for each time series}
