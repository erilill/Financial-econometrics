...
par(mfrow=c(1,1))
```
Above, you see the ACF-plots for the individual series. We see spikes outside of the confidence interval for series 3, 4, 5, 6 and 7, indicating that we have significant autocorrelations. Similairly, we can calculate and plot the individual partial autocorrelations:
...
In this question, we are asked to perform Ljung-Box tests on the individual series. 
