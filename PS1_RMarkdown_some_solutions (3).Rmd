...
kable(round(gamma_matrices$gamma_0, 3), caption = "$\\gamma_0$", label = "gamma0")
kable(round(gamma_matrices$gamma_1, 3), caption = "$\\gamma_1$", label = "gamma1")
kable(round(gamma_matrices$gamma_2, 3), caption = "$\\gamma_2$", label = "gamma2")
kable(round(gamma_matrices$gamma_3, 3), caption = "$\\gamma_3$", label = "gamma3")
kable(round(gamma_matrices$gamma_4, 3), caption = "$\\gamma_4$", label = "gamma4")
