...
We can see that the densities look more skewed than the standard normal distribution, and more density close to the means. We can look at descriptive statistics to find out exactly.

```{r PLOT1, echo=F}
describe(DJ_d$r_Dow_Jones)
describe(DJ_w$r_close)
```
Both series have means of zero. Daily returns has standard deviation 0.01 and weekly returns 0.03. Daily returns has a skewness of -0.96 and kurtosis of 36.6. 

Weekly returns is slightly more skewed with -1.09 but kurtosis is 15.06.
