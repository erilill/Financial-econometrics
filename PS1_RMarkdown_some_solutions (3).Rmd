...
gamma_matrices$gamma_1
```
The tables above show cross-autocorrelations between the financial indices for $k=\{0,1,3,4\}$. With these tables we aim to analyze whether there are any lead-lag relationships.
