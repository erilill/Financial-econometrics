...
t_plot_1_df3<- tmp + geom_qq(distribution=extraDistr::qlst, dparams=list(df=df,
  ...
  geom_abline(aes(intercept=0,slope=1),color="red")+ggtitle("Standardized Daily Log Returns")
...
t_plot_2_df3<- tmp + geom_qq(distribution=extraDistr::qlst, dparams=list(df=df,
  ...
  geom_abline(aes(intercept=0,slope=1),color="red")+ggtitle("Standardized Weekly Log Returns")
