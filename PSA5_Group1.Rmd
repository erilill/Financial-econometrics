...
kable(
  ...
  caption = "Value-at-Risk Estimates from unconditional t-distributed moments",
  digits = 3
)
```
...
kable(
  VaR_df,
  col.names = c("Probability", "Horizon (h=1)", "Horizon (h=10)", "Horizon (h=30)", "V"),
  caption = "Value-at-Risk Estimates from Gaussian GARCH(1,1) with constant conditional mean DJ Daily",
  digits = 3
)
```
