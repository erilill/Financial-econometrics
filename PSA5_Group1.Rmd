...
matplot(tmp, type = "l", lty = 1, col = 1:ncol(tmp), xlab = "Time", ylab = "VaR", main = "VaR over time (daily)")
legend("topright", legend = colnames(tmp), col = 1:ncol(tmp), lty = 1, title = "Tail probabilities")
```
...
matplot(tmp, type = "l", lty = 1, col = 1:ncol(tmp), xlab = "Time", ylab = "VaR", main = "VaR over time (weekly)")
legend("topright", legend = colnames(tmp), col = 1:ncol(tmp), lty = 1, title = "Tail probabilities")
```
