...
BIC suggests 5 factors for all models.
...
# Display the R-squared table
kable(r_squared_market, caption = "R-squared values for the regressions with the market risk premium")
```
