...
sur <- function(Z, Z_k){
  ...
  return(list(mu_k=mu_k, B_hat=B_hat, alpha_hat=alpha_hat, Sigma_hat=Sigma_hat, residuals = residuals))
}
...
LR <- 2 * (LogLikelihood(sur1$residuals) - LogLikelihood(restricted_model$residuals))
df <- ncol(sur1$B_hat) - ncol(restricted_model$B_hat)
