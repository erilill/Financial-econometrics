...
So now we test jointly for exact factor pricing in all equations. We estimate the SUR model and do the F-test for $\alpha$. Here are the functions
...
We can see that we reject the null that $\alpha=0$, so we do not have evidence exact factor pricing.
