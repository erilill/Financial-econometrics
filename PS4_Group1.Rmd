...
kable(correlations_with_market, caption = "Correlation of each factor portfolio (of the 100 size-book-to-market) with the market portfolio:")

correlations_with_market_20 <- sapply(colnames(pc_scores_20), function(factor) {
  cor(pc_scores_20[,factor], portfolio_m[,3])
})

kable(correlations_with_market_20, caption = "Correlation of each factor portfolio (of the 20 size and book-to-market) with the market portfolio:")
```
