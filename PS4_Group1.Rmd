...
pca_res_100 <- PCA(as.matrix(portfolio_m[,25:124]), 5) #100 size book
pc_scores_100 <- pca_res_100$factors
pc_scores_excess <- sweep(pc_scores_100, 1, Rf)
```
...
```{r}
factor_model_1fac_1st <- lm(mZ[, 1] ~ pc_scores_excess[,1])
factor_model_2fac_1st <- lm(mZ[, 1] ~ pc_scores_excess[,1:2])
factor_model_3fac_1st <- lm(mZ[, 1] ~ pc_scores_excess[,1:3])
factor_model_4fac_1st <- lm(mZ[, 1] ~ pc_scores_excess[,1:4])
factor_model_5fac_1st <- lm(mZ[, 1] ~ pc_scores_excess)

factor_model_1fac_5th <- lm(mZ[, 5] ~ pc_scores_excess[,1])
factor_model_2fac_5th <- lm(mZ[, 5] ~ pc_scores_excess[,1:2])
factor_model_3fac_5th <- lm(mZ[, 5] ~ pc_scores_excess[,1:3])
factor_model_4fac_5th <- lm(mZ[, 5] ~ pc_scores_excess[,1:4])
factor_model_5fac_5th <- lm(mZ[, 5] ~ pc_scores_excess)

factor_model_1fac_10th <- lm(mZ[, 10] ~ pc_scores_excess[,1])
factor_model_2fac_10th <- lm(mZ[, 10] ~ pc_scores_excess[,1:2])
factor_model_3fac_10th <- lm(mZ[, 10] ~ pc_scores_excess[,1:3])
factor_model_4fac_10th <- lm(mZ[, 10] ~ pc_scores_excess[,1:4])
factor_model_5fac_10th <- lm(mZ[, 10] ~ pc_scores_excess)

# Extract R-squared values for each model
r_squared_table <- data.frame(
  Portfolio = c("1st", "5th", "10th"),
  `1 Factor` = c(
    round(summary(factor_model_1fac_1st)$r.squared,2),
    round(summary(factor_model_1fac_5th)$r.squared,2),
    round(summary(factor_model_1fac_10th)$r.squared,2)
  ),
  `2 Factors` = c(
    round(summary(factor_model_2fac_1st)$r.squared,2),
    round(summary(factor_model_2fac_5th)$r.squared,2),
    round(summary(factor_model_2fac_10th)$r.squared,2)
  ),
  `3 Factors` = c(
    round(summary(factor_model_3fac_1st)$r.squared,2),
    round(summary(factor_model_3fac_5th)$r.squared,2),
    round(summary(factor_model_3fac_10th)$r.squared,2)
  ),
  `4 Factors` = c(
    round(summary(factor_model_4fac_1st)$r.squared,2),
    round(summary(factor_model_4fac_5th)$r.squared,2),
    round(summary(factor_model_4fac_10th)$r.squared,2)
  ),
  `5 Factors` = c(
    round(summary(factor_model_5fac_1st)$r.squared,2),
    round(summary(factor_model_5fac_5th)$r.squared,2),
    round(summary(factor_model_5fac_10th)$r.squared,2)
  )
)


colnames(r_squared_table) <- c("Portfolio", "1 Factor", "2 Factors", "3 Factors", "4 Factors", "5 Factors")
kable(r_squared_table, caption = "R-squared values for different factor models")

bic_1fac_1st <- round(BIC(factor_model_1fac_1st),2)
bic_2fac_1st <- round(BIC(factor_model_2fac_1st),2)
bic_3fac_1st <- round(BIC(factor_model_3fac_1st),2)
bic_4fac_1st <- round(BIC(factor_model_4fac_1st),2)
bic_5fac_1st <- round(BIC(factor_model_5fac_1st),2)

bic_1fac_5th <- round(BIC(factor_model_1fac_5th),2)
bic_2fac_5th <- round(BIC(factor_model_2fac_5th),2)
bic_3fac_5th <- round(BIC(factor_model_3fac_5th),2)
bic_4fac_5th <- round(BIC(factor_model_4fac_5th),2)
bic_5fac_5th <- round(BIC(factor_model_5fac_5th),2)

bic_1fac_10th <- round(BIC(factor_model_1fac_10th),2)
bic_2fac_10th <- round(BIC(factor_model_2fac_10th),2)
bic_3fac_10th <- round(BIC(factor_model_3fac_10th),2)
bic_4fac_10th <- round(BIC(factor_model_4fac_10th),2)
bic_5fac_10th <- round(BIC(factor_model_5fac_10th),2)

# Create a table with BIC values
bic_table <- data.frame(
  Portfolio = c("1st", "5th", "10th"),
  `1 Factor` = c(bic_1fac_1st, bic_1fac_5th, bic_1fac_10th),
  `2 Factors` = c(bic_2fac_1st, bic_2fac_5th, bic_2fac_10th),
  `3 Factors` = c(bic_3fac_1st, bic_3fac_5th, bic_3fac_10th),
  `4 Factors` = c(bic_4fac_1st, bic_4fac_5th, bic_4fac_10th),
  `5 Factors` = c(bic_5fac_1st, bic_5fac_5th, bic_5fac_10th)
)


colnames(bic_table) <- c("Portfolio", "1 Factor", "2 Factors", "3 Factors", "4 Factors", "5 Factors")
kable(bic_table, caption = "BIC values")
```

BIC suggests 5 factors for all models, (lowest BIC is best).
...
pca_res_20 <- PCA(as.matrix(portfolio_m[,5:24]), 5) #20 size book
pc_scores_20 <- pca_res_20$factors
pc_scores_excess_20 <- sweep(pc_scores_20, 1, Rf)


factor_model_5fac_1st_100 <- lm(mZ[, 1] ~ pc_scores_excess_100)

factor_model_5fac_5th_100 <- lm(mZ[, 5] ~ pc_scores_excess_100)

factor_model_5fac_10th_100 <- lm(mZ[, 10] ~ pc_scores_excess_100)

factor_model_5fac_1st_20 <- lm(mZ[, 1] ~ pc_scores_excess_20)

factor_model_5fac_5th_20 <- lm(mZ[, 5] ~ pc_scores_excess_20)

factor_model_5fac_10th_20 <- lm(mZ[, 10] ~ pc_scores_excess_20)

# Extract R-squared values for each model
r_squared_100 <- data.frame(
  Portfolio = c("1st", "5th", "10th"),
  `100 Size-Book-to-Market` = c(
    round(summary(factor_model_5fac_1st_100)$r.squared, 2),
    round(summary(factor_model_5fac_5th_100)$r.squared, 2),
    round(summary(factor_model_5fac_10th_100)$r.squared, 2)
  )
)

r_squared_20 <- data.frame(
  `20 Size-Book-to-Market` = c(
    round(summary(factor_model_5fac_1st_20)$r.squared, 2),
    round(summary(factor_model_5fac_5th_20)$r.squared, 2),
    round(summary(factor_model_5fac_10th_20)$r.squared, 2)
  )
)

# Combine the R-squared values into one table
r_squared_comparison <- cbind(r_squared_100, r_squared_20)

colnames(r_squared_comparison) <- c("Portfolio", "PCA based on 100 size-book-to-market","PCA based on 20 size and book-to-market")
kable(r_squared_comparison, caption = "Comparison of R-squared values")
...
We can see that the best goodness of fit is obtained for the regression for the 5 factor model based on the 20 portfolios for the 10th portfolio. The worst goodness of fit is for the regression for the 1 factor model (market excess returns) for the 5th portfolio.
...
kable(cbind(resultsb3c[,c(1,8:9)],results[,6]), digits = 3, caption = "Comparison of R2 between the estimated three factor and CAPM model for the portfolios", label = "tab:3factor", col.names =  c("Portfolio", "R2 (three factor + PCA)", "R2 (PCA)", "R2 (three factors)"))
```
