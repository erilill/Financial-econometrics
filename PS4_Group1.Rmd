...
```{r}
colnames(pc_scores_excess_20) <- paste0("Excess_PC", 1:5)
pc_scores_excess <- as.data.frame(pc_scores_excess_20)
cols <- c("R11", "R15", "R110", "R51", "R55", "R510", "R101", "R105", "R1010")
...
for (i in cols){
  ...
  comp <- lm(ER ~pc_scores_excess$Excess_PC1 + pc_scores_excess$Excess_PC2)
