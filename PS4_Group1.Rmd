...
We can see that we reject the null that $B=0$, i.e. the factors are jointly significant at a 1\% level.
...
We reject the null that $B=0$,i .e. the market risk premium is jointly significant.
