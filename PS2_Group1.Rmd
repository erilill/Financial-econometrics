...
We cannot find anything that would indicate a structural break in the different time periods for either daily nor weekly data. It is the same story as before, the ACF plot tell us that in all periods there is quite strong evidence for predictability for the daily data, and not so much for the weekly data.
