...
par(mfrow=c(1,1))
```
Looking at the ACF-plots above we see significant auto-correlations for both the low and top 10\%. Positive auto-correlations indicates asset return predictability.
