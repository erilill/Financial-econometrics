...
par(mfrow=c(1,2))
p3 <- Acf(twoday_ann, lag.max = 20, main = "Dow Jones two day annualized log returns")
p4 <- Acf(twoweek_ann, lag.max = 20, main = "Dow Jones two-week annualized log returns")
par(mfrow=c(1,1))
```

>>>>>>> 8172b1b8f32cba3dcf02155b70cbf7fa174ab59b
