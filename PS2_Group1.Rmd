...
When negative lag, it means that the returns of Lo_10 is compared to the future returns of the Hi_10. When positive lags it means that the Hi_10 is compared to the future returns of the Lo_10. We observe significant lags both for negative and positive lags. Furthermore, the lags are in both directions, both positive and negative cross autocorrelations and for this reason it is very hard to draw a conclusion that supports the theory. We will continue by dividing it into subperiods. 
