...
#kable(res, format = "latex", booktabs = TRUE) # Necessary to produce latex table 
```
\begin{tabular}{rr}
\toprule
Lag & ACF\\
...
# Ljung-Box and lastly sub periods 
