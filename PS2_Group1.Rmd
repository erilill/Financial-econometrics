...
#  ACF = res[["acf"]]
#)
#kable(res_df, format = "latex", booktabs = TRUE) # Necessary to produce latex table 
```
\begin{tabular}{rr}
\toprule
Lag & ACF\\
...
# Ta bort när vi är färdiga innan inlämning
#res_1df <- data.frame(
#  Lag = res_1[["lag"]], 
#  ACF = res_1[["acf"]]
#)
...
#### res_f <- reduce(list(res_1df, res_2df, res_3df), left_join, by = "Lag")
#kable(res_f, format = "latex", booktabs = TRUE) # Necessary to produce latex table 
```
...
# Här är jag väldigt rädd om lag har blivit rädd. 
