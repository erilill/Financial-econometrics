...
So because we see significant auto-correlations for the first few lags in the daily data, this is an indication of asset return predictability on the daily level.
...
\begin{table}[ht]
\centering
\caption{Ljung-Box Test Results for Two-Day Aggregated Series}
\begin{tabular}{lccl}
\hline
\textbf{Lag} & \textbf{Test Statistic} & \textbf{p-value} \\
\hline
10   & 64.681  & 0.00\\
20   & 110.169 & 0.00\\
\hline
