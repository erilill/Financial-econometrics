...
$$
Z_t = \gamma_{0t} \iota + \gamma_{1t}\hat{\beta}_{1m} + \gamma_{2t}\hat{\beta}_{2m}+\gamma_{3t}\hat{\beta}_{3m} + \eta_t
$$
Where $\hat{\beta}_{2m}$ and $\hat{\beta}_{3m}$ are the estimated coefficients for $log(Size)$ and $log(book-to-market)$ respectively for each portfolio $m$.
