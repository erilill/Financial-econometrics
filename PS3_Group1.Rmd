...
SecondPass_2 <- function(beta, mZ, size, bm){
  ...
  return(list(gamma0=gamma0,g0sd=g0sd,mrprem=mrprem,gamma_size=gamma_size, gamma_bm=gamma_bm,  prsd=prsd,wgamma0=wgamma0,wgamma1=wgamma1,wgamma_size=wgamma_size,wgamma_bm=wgamma_bm, iT=iT))
}
...
R2 <- numeric(nrow(mZ))
for (iter in 1:iT){
  fit <- lm(formula = mZ[iter, ] ~ log(tmp$beta))
