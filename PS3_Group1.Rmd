...
```
Goodness-of-fit provide evidence that for period 1 the model explains around 68\% of the variability. For period 2 we see a higher $R^2$ around 73\% and for period 3 we observe $R^2$ around 75\%. The adjusted $R^2$ takes into consideration number of predictors and adjusts the $R^2$ downward. We see that the adjusted $R^2$ is very similar to the standard $R^2$ meaning that it doesn't seem that we overfit the data by adding too many variables. 
